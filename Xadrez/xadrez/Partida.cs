...
namespace xadrez
{
    class Partida
    {
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCaputrada)
        {
            ...
            if (p is Peao)
            {
                if (origem.coluna != destino.coluna && pecaCaputrada == vulneravelEnPassant)
                {
